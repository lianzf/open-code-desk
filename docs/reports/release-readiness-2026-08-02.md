...
| 当前源码对应的 macOS 产物         | CI run `31247288230` 的 macOS job `93078366590` 在 `macos-15` ARM64 完成真实 Java 调试、DMG/ZIP 构建、运行时完整性与已打包应用 E2E；仅最终 artifact 上传因配额失败。                                                                                                                                                                                                                                                                                | 当前产品树的原生自动化满足；缺少可下载 artifact，且未签名/notarize、无独立人工设备证据 |
