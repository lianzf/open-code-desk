...
| 当前源码对应的 Windows 安装包     | CI run `30933901524` 从提交 `2da293f` 构建 0.7 NSIS，并完成运行时完整性、安装烟测和已安装应用 E2E；下载后的安装包为 181,391,882 字节，SHA-256 `C86654663A807DAB2D7543A588A1009773E1857E56A12B7F6664F3755A64AA59`，重算值与随包 `SHA256SUMS.txt` 一致，Authenticode 状态为 `NotSigned`。先前本地候选另完成 9/9 核心 E2E、6/6 桌面壳/持久化 E2E、1.61 秒冷启动、正常关闭零残留与静默卸载。                                                            | 当前公共 CI 未签名候选通过                                                        |
