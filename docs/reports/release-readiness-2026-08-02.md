...
结论：核心产品闭环与本地质量门禁已通过；当前候选的三平台公共 CI attempt 2 全部成功，四个必需 artifact 已下载并完成 19/19 清单与哈希核验。按 2026-08-09 调整后的范围，该候选满足受控内部 Alpha 交付；正式签名、真实 Provider 与独立设备验收仍缺失，正式发布明确延期。
...
| 当前源码对应的 Windows 安装包     | 当前提交 `07ac062` 的本机全新 NSIS 为 182,383,713 字节，SHA-256 `3F351D2B9B895A516DFE5587BD6304FD3B13F69F90DF0DF2D7F33D9617732223`，清单 6/6 一致，Authenticode 为 `NotSigned`；安装/卸载、3.99 秒冷启动、零残留、已安装核心 E2E 9/9 与桌面壳/持久化 E2E 6/6 均通过。CI run `31247288230` attempt 2、Windows job `93169391300` 也完成构建、安装烟测、已安装 E2E 与 artifact 上传；公共 NSIS 为 182,383,604 字节，SHA-256 `96FB70C58853376C31C4C266407FBCDBC2D0043F979BD857ED0E5CFD91633BF1`，清单 6/6 一致，Authenticode 同为 `NotSigned`。 | 当前未签名本地候选与公共 Windows 自动化、制品核验均通过                     |
...
| 当前源码对应的 Linux x64 AppImage | CI run `31247288230` attempt 2 的 Linux job `93169391314` 在原生 runner 完成 JDK 21 Java 调试、AppImage 构建、运行时完整性、已打包应用 E2E 与 artifact 上传；公共 AppImage 为 213,150,102 字节，SHA-256 `9C48B1A8C17D9F979C78C9EF43FC9C370A39D94A25DC525A83DD104DA2541C50`，清单 5/5 一致。                                                                                                                                                                                                                                                 | 满足“Linux 至少可构建”、当前产品树公共原生自动化与制品核验                  |
| 当前源码对应的 macOS 产物         | CI run `31247288230` attempt 2 的 macOS job `93169391317` 在 `macos-15` ARM64 完成真实 Java 调试、DMG/ZIP 构建、运行时完整性、已打包应用 E2E 与 artifact 上传；DMG 为 204,601,360 字节、SHA-256 `AF5C51A6AC76A95B558606508F55676050DFD91A9F79E6E7986E532A42C30C62`，ZIP 为 204,948,500 字节、SHA-256 `17D4E5BD9C8297750B4E78A25AE3B867B6F141D25A4ABF4F9E10B21F3F3A511A`，清单 8/8 一致。                                                                                                                                                    | 当前产品树的原生自动化与制品核验满足；仍未签名/notarize、无独立人工设备证据 |
